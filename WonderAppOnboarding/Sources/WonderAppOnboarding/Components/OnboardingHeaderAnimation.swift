...
private final class HeaderAnimationScene: SKScene {
    enum Category {
...
struct HeaderAnimation: View {
    @State private var _scene: HeaderAnimationScene?
        ...
        GeometryReader { geo in
            ...
            .onAppear {
                guard let scene = _scene else {
                    let scene = HeaderAnimationScene()
...
struct HeaderAnimationPreviews: PreviewProvider {
